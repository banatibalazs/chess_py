...
class TestPlayer(unittest.TestCase):
    ...
    def set_king_position_and_update(self, row, col):
        ...
        if self.white_player.has_piece_at(row, col):
            self.white_player.get_piece_at(row, col).coordinates = self.white_player.get_king().coordinates

        self.white_player.get_king().coordinates = (row, col)
        ...
        self.white_player.update_pieces_possible_fields(self.black_player)
        self.black_player.update_pieces_possible_fields(self.white_player)
